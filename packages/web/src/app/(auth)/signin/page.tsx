      ...
      <div className="relative w-full max-w-md animate-fade-up">
        ...
        <div className="card p-8">
          ...
          >
            ...
            <span className="font-mono text-sm text-cream">Continue with Google</span>
          </button>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="label-mono text-xs text-cream-muted">Password</label>
                <Link href="/password-reset" className="label-mono text-xs text-amber hover:underline">
                  Forgot password?
                </Link>
              </div>
          ...
          {/* Footer */}
          <p className="text-center mt-6 text-sm text-cream-muted" style={{ fontFamily: 'var(--font-source-serif)' }}>
