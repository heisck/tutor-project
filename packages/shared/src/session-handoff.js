...
export const sessionHandoffSnapshotInputSchema = sessionHandoffSnapshotSchema.partial({
    currentSectionId: true,
    currentSegmentId: true,
    currentStep: true,
});
export const sessionHandoffSnapshotRecordSchema = sessionHandoffSnapshotSchema.extend({
