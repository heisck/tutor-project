...
The bundled frontend workspace has been removed from this repository.
Do not add new browser UI code unless the user explicitly asks for a new frontend surface.
